		...
		btnVarify.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(org_name.equals("")){
					...
					String message = "please add our organization "+org_name+" as an authorized organization";
						String number = "5556";
		...
		btnRegister.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (org_name.trim().equals("")) {
					eTcode.setError("org_name is required!");
					// You can Toast a message here that the Username is Empty
				}
				if (phone_num.trim().equals("")) {
					eTcode.setError("phone number is required!");
					// You can Toast a message here that the Username is Empty
				}
				else{
			...
			if (json != null) {
				try {
					...
					for (int i = 0; i < matchFixture.length(); i++) {
						...
						if (org_name.trim().equals(orgname)) {
