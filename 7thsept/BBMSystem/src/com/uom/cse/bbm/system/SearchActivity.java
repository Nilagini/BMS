...
/**
 * 
 * @author T.Nilasni find all donors's distance from organization's location
...
public class SearchActivity extends ActionBarActivity {
	...
	private static String URL_ITEMS = "http://10.0.2.2/bbms/get_data.php";
	...
	private static List<String> distanceList = new ArrayList<String>();
	private static ArrayList<HashMap<String, String>> availableDonorsList = new ArrayList<HashMap<String, String>>();

	/**
	 * load the searchpage to indicate the specific bloodgroup and location
	 */
	@Override
	...
	/**
	 * 
	 * onclick action for search button
	 * 
	 */
